...
class SearchComponent extends React.Component {
    ...
    _renderProduct = ({product}, {key}) => (
        <TouchableOpacity activeOpacity={1}
                          onPress={() => this.props.navigation.navigate("ProdDetails", {
                              item: product
                          })} style={{
        ...
        return (
            <ScrollView>
                <View style={{marginTop: 0}}>
                    ...
                    <View>
                        <Text style={{textAlign: "center", color: theme.lightTextColor}}>No Items Found</Text>
                    </View>:<></>
                    }
                    {this.state.products.length === 0 && this.state.searchText === "" ?
                        <View>
                            <Text style={{textAlign: "center", color: theme.lightTextColor}}>Search for all the Products here...</Text>
                        </View>:<></>
                    }
