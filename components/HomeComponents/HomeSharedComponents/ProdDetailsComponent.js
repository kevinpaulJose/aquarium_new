        ...
        return (
            <View>
                ...
                <View style={{
                    ...
                    <Image source={{uri: this.state.item.image}} style={{
                        width: ScreenWidth - 40,
                        height: ScreenWidth - 40,
                        borderRadius: 20
                    }}/>
                    <View style={{
                        ...
                        <Text style={{color: theme.mainBg, fontSize: 12, fontWeight: "bold"}}>
...
export default connect(mapStateToProps, mapDispatchToProps)(ProdDetailsComponent);
