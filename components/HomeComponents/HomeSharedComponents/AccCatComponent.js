...
class AccCatComponent extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      products: [],
    ...
    return (
      <View style={{ width: ScreenWidth, alignItems: "center", marginTop: 30 }}>
        <View style={{ width: ScreenWidth - 40 }}>
          <View style={{ width: ScreenWidth - 40, height: 30 }}>
            <View>
              <Text style={{ fontSize: 18, color: theme.darkTextColor }}>
                Shop Decors and Accessories
              </Text>
            </View>
            <TouchableOpacity
              onPress={() =>
                this.props.navigation.navigate("Specific", { item: "decor" })
              }
          ...
          >
            <Image
              source={require("../../../assets/decor.jpg")}
              style={{
                width: ScreenWidth - 40,
                height: 190,
                resizeMode: "cover",
          ...
          {this.props.prodData.isLoading ? (
            ...
            >
              {this.props.prodData.data
                .filter(
                  (product) =>
                    product.category === "decor" && parseInt(product.stock) > 0
                )
                .slice(0, 4)
                .map((product, key) => (
...
export default connect(mapStateToProps, mapDispatchToProps)(AccCatComponent);
